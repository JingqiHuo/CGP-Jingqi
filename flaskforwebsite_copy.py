...
def retrieve():
    ...
    return render_template('table1_copy.html', table=data, title=title, species=get_species_list())
...
def map():
    ...
    with connect.cursor() as c:
            ...
            data = c.fetchall()
            print(data)
    with open('Captial-Greenspaces-Project-Group-3-main/static/boundary.json') as file:
